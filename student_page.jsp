...
<!--
      ...
      Description   : This is student page where student can add,register for events.
			...
			<div class="row">
				...
				<div class="col-md-8">
					<div class="pull-right">
						<ul class="sn-topMenu">
							<li><a href="user.jsp"><img src="images/profile.png" class="img-circle" width="60"></a></li>
              <%
                   String query9 = "select name from users where  rollno = '"+username+"'";
                                     ...
                                     %>
                                      ...
                                      <%
                                       ...
                                       %>
							<li><a href="placement.jsp">Placement News</a></li>
						 ...
						 <%
						    ...
						    if(rs.next())
						    	 id = rs.getInt("id");    
                            	  ...
                            	  int rowCount1=0;
                            	       String query2 = "select * from registered where uid = "+id+"";
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary">Save changes</button>
                 ...
                 <!-- REGISTER FOR EVENTS (BOOTSTRAP MODAL) -->
                    <div class="pull-right">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <label>Event ID<input type="text" name="eid" required=""></label></br/>
          ...
          <% 
          String query4 = "select * from users where rollno = '"+username+"'";
